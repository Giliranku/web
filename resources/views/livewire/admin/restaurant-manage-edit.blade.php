{{-- resources/views/livewire/admin/attracion-list-manage-edit.blade.php --}}
<div>
    {{-- Desktop Version --}}
    <div class="d-none d-md-flex justify-content-center align-items-start"
        ...
        <div class="card my-5 w-100"
            ...
            <form wire:submit.prevent="update" class="d-flex flex-column gap-4">
                <div class="d-flex gap-4">
                    ...
                    <div class="d-flex flex-column" style="width:40%;">
                        ...
                        @elseif($existingPhoto)
                            <img src="{{ asset('storage/' . $existingPhoto) }}" class="w-100 rounded-3"
                                style="height:200px; object-fit:cover;" />
                        @else
                            <label for="photo"
