<div x-data :style="$store.sidebar.collapsed ? 'width: 80px; height: 100vh;' : 'width: 250px; height: 100vh;'"
    ...
    <!-- Fixed bottom area -->
    <div class="border-top p-2 d-flex flex-column gap-2 flex-shrink-0"
        :class="$store.sidebar.collapsed ? 'align-items-center' : ''" style="background: #fff; transition: all 0.3s;">
